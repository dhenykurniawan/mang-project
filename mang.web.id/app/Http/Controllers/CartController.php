...
class CartController extends BaseController{
	...
	public function store(Request $request){
		if($request->ajax()){
			...
			$produk_nama = $request->get("produk_nama");
			$produk_shortdesc = $request->get("produk_shortdesc");
			$harga_jual = $request->get("harga_jual");
			$harga_promo = $request->get("harga_promo");
			$produk_gambar = $request->get("produk_gambar");
			$produk_someday = $request->get("produk_someday");
			$produk_qty = $request->get("produk_qty");
    ...
    public function form_address(Request $request){
		...
		if($request->get("edit")){
			...
			$data_address = Cs_Address::
							join("st_kelurahan","st_kelurahan.kelurahan_id","=","cs_address.kelurahan_id")
